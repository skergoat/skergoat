...
Upon registering, a 7-day trial of an unlimited version of the app is assigned to your account. After the trial expires, you will be asked if you'd like to subscribe to a paid package (they start from $15 a month) or downgrade to the basic version. That way you are still able to use the chat for free, for an unlimited time :)
