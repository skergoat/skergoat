    ...
    $('.down').click(function() {
        ...
        if($(this).hasClass('skill-box')) {
            ...
            switch(skill_box_id) {
                ...
                var section_2_p2 = "Dans Wordpress vous customisez vous-même les pages, les couleurs, les polices, etc. et bien sûr vous créez votre propre contenu. <span class='strong'>C’est l’outil parfait pour créer son blog !</span>";
                ...
                var section_2_p5 = "<span class='strong'>Si vous travaillez sur Wordpress, vous n’aurez sans doute pas besoin d’un designer</span>. Les thèmes sont souvent bien faits et suffisent dans la plupart des cas. ";
                ...
                var section_2_p8 = "« Responsive » veut dire « adaptable » en anglais. <span class='strong'>Un design « responsive » veut dire qu’il s’adapte à différents formats d’écrans (smartphone, tablette, etc.).</span>";
                ...
                var section_2_p10 = "<span class='strong'>Mais aujourd’hui les choses ont changé : le smartphone a remplacé l’ordinateur pour la consulation d’internet et les designers ont dû suivre</span>. Ils ont donc créé un design « responsive », adaptable aux différentes tailles d’écrans. Vérifiez vous-mêmes : si vous réduisez la taille de cette page, vous verrez que mon site s’adapte parfaitement.";
                ...
                var sectionP3 = "Pour cela il faut que nous créions dès le départ un dialogue constructif et cordial. De mon côté, je me mets à votre disposition et suis ouvert à toutes vos remarques.  Du vôtre, vous me dites tout ce que vous pensez, avec franchise et simplicité. Si, à la fin de notre travail, « site web » rime pour vous avec « sérénité », ma mission sera accomplie !";
                break;
                ...
                var sectionP3 = "Vous ne connaissez rien au web et ce que je dis ne vous parle pas ? Je vous invite à découvrir mon portfolio. Je suis sûr que cela suffira pour vous convaincre."
                break;
